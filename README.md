...
Для решения этой задачи я представил реализацию `Heapsort` или «Сортировку кучей», я выбрал этот  алгоритм сортировки, так как он работает в худшем, в среднем и в лучшем случае (то есть гарантированно) за  O(nlog n) операций при сортировке n элементов, а также количество применяемой служебной памяти не зависит от размера массива (то есть, O(1)).
